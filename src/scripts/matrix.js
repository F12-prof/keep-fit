import { Container, Sprite, ParticleContainer, Ticker, Texture, Graphics, BLEND_MODES } from "pixi.js";
...
export default class Matrix extends Container {
    ...
    constructor(sceneWidth, sceneHeight, maxBinNumColumns) {
        ...
        this.binParticleContainer = new ParticleContainer();
        ...
        const emitter = this.binParticleEmitter = new particles.Emitter(this.binParticleContainer, 
        //pixi.autoDetectRenderer().generateTexture(textureGraphic),
        Texture.from(matrixAssets.particleTexturePath), matrixAssets.emitterSetting);
        // Setting properties
